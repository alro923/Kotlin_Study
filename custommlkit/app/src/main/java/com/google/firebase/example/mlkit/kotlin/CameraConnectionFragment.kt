...
open class CameraConnectionFragment(callback: (Size, Int) -> Unit, imageListener: OnImageAvailableListener, layout: Int, inputSize: Size)
    ...
    companion object {
        ...
        //        fun newInstance(callback: (Nothing, Nothing) -> Unit,
//                        imageListener: OnImageAvailableListener,
//                        layout: Int,
//                        inputSize: Size) : CameraConnectionFragment {
//            Log.e("로그", "c : $callback i : $imageListener l : $layout i : inputSize")
...
//        }
        fun newInstance(
                ...
                layout: Int?,
                inputSize: Size?): CameraConnectionFragment {
            if (callback != null && imageListener != null && layout != null && inputSize != null) {
                Log.e("로그", "c : $callback i : $imageListener l : $layout i : inputSize")
                return CameraConnectionFragment(callback, imageListener, layout, inputSize)
            }
            // return
