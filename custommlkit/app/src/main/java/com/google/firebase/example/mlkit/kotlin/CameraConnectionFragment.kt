...
open class CameraConnectionFragment(callback: (Nothing, Nothing) -> Unit, imageListener: OnImageAvailableListener, layout: Int, inputSize: Size) : androidx.fragment.app.Fragment() {
    ...
    companion object {
        ...
        fun newInstance(callback: (Nothing, Nothing) -> Unit, imageListener: OnImageAvailableListener, layout: Int, inputSize: Size) : CameraConnectionFragment {
        ...
        private val stateCallback: CameraDevice.StateCallback = object : CameraDevice.StateCallback() {
            ...
            private fun createCameraPreviewSession() {
                try {
                    ...
                    previewReader!!.setOnImageAvailableListener(this@CameraConnectionFragment.imageListener, backgroundHandler)
