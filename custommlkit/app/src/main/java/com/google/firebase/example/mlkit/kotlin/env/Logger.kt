...
class Logger @JvmOverloads constructor(private val tag: String = DEFAULT_TAG, messagePrefix: String? = null) {
    companion object {
        ...
        private var IGNORED_CLASS_NAMES: MutableSet<String>? = null// We're only interested in the simple name of the class, not the complete package.// Get the current callstack so we can pull the class of the caller off of it.
